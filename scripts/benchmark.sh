...
echo  time_for_local_setup $time_for_local_setup >> benchmark_time
...
echo  time_for_cloud_setup $time_for_cloud_setup >> benchmark_time
...
echo  time_for_hadoop_deploy $time_for_hadoop_deploy >> benchmark_time
...
echo  time_for_opencv_setup $time_for_opencv_setup >> benchmark_time
...
echo  time_for_sign_detection $time_for_sign_detection >> benchmark_time
...
echo time_for_data_transfer $time_for_data_transfer >> benchmark_time
...
echo time_for_env_cleanup $time_for_clean_up >> benchmark_time
